import type { GroupedSections, ModifiedSection } from "./Section";
...
function parseEnrollment(section: ModifiedSection | null | undefined) {
  const value = section?.enrollment?.split("/")[0] || "0";
