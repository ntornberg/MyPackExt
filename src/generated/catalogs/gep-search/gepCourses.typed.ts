...
export const GEP_COURSES = {
  ...
  GLOBAL: {
    ...
    "IPGK-295": {
      course_title:
        "Interdisciplinary Perspectives and Global Knowledge Special Topics",
      course_id: "031853",
    },
    "NSGK-295": {
  ...
  INTERDISC: {
    ...
    "IPUS-295": {
      course_title:
        "Interdisciplinary Perspectives and U.S. Diversity Special Topics",
      course_id: "031854",
    },
    "GIS-205": {
...
export function getGEPCourse<G extends GEPCode, C extends CourseCode<G>>(
  code: G,
  catalog: C,
): GEPCourseDetails<G, C> {
